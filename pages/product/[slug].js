          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <p className="leading-relaxed">
                A stunning white ring diamond, crafted with precision and
                elegance, capturing the essence of everlasting beauty. This
                exquisite piece sparkles with a brilliance that enchants hearts.
                Perfect for those who appreciate the allure of fine jewelry,
                radiating grace and sophistication.
              </p>
